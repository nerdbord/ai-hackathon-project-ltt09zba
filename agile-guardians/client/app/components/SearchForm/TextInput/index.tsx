  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <input
        ...
        id="search"
        autoComplete="off"
        className="h-[48px] w-[300px] sm:w-[320px] cursor-pointer rounded-lg border border-placeholder px-4 py-3 font-semibold text-input focus:border-2 focus:border-inputFocus focus:outline-none focus:placeholder:text-input"
